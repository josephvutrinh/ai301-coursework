...
I am a computer science junior. I work mostly in TypeScript and React (Next.js, Tailwind) and in Java, and I have used Python for smaller scripts and tooling. I have built and shipped web front ends in a job and in an internship, so UI, component, and styling work is where I am fastest. I want to get better at reading unfamiliar codebases and at backend and systems-level work, so a small bug in a Python or Java codebase interests me even though I would be slower on it. I would rather avoid issues that need deep knowledge of a framework I have never used, or work that is mostly documentation with no code change.